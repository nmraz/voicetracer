...
class DBHandler(object):
    '''Holds a database connection and allows for descriptions to be found for corresponding
    syscall names
    '''
    ...
    def lookup(self, name):
        '''Looks up the specified syscall in the database and returns its description, if any'''
        cur = self.con.cursor()
